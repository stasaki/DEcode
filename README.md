...
DEcode predicts inter-tissue variations and inter-person variations in gene expression levels from [TF-promoter interactions](https://doi.org/10.1093/nar/gky1128), [RNABP-mRNA interactions](https://doi.org/10.1093/nar/gky830), and [miRNA-mRNA interactions](https://doi.org/10.7554/eLife.05005).
